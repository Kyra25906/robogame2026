...
| 查看现场第一天逐项操作 | [FIELD_DAY1_EXECUTION_ORDER.md](field/FIELD_DAY1_EXECUTION_ORDER.md) | 带到现场照表执行并保存证据 |
...
- [FREEZE_TABLE.md](field/FREEZE_TABLE.md)：电控、机械、算法共同确认的接口冻结表；未知字段不得猜测。
...
- [MCU_PROTOCOL.md](field/MCU_PROTOCOL.md)：已经冻结的串口外层协议；内部载荷仍以电控最终表格为准。
...
- `history/DEVELOPMENT_PLAN_2026-08-06_TO_14.md`（原始计划，当前执行以新计划为准）
